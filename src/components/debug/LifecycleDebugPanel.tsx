...
export function LifecycleDebugPanel({
  isVisible = false,
  onClose,
}: LifecycleDebugPanelProps) {
  ...
  const [analysis, setAnalysis] = useState<{
    ...
    mountEvents: number;
    errorEvents: number;
    potentialReloads: boolean;
    hasErrors: boolean;
    lastMountEvent?: unknown;
        ...
        <CardHeader>
          <div className='flex items-center justify-between'>
            <div>
              ...
              <CardDescription>
                Monitor application lifecycle events and detect potential reload
                causes
              </CardDescription>
            </div>
            <div className='flex items-center gap-2'>
              ...
              <Button
                variant='outline'
                size='sm'
                onClick={() => appLifecycleLogger.clearEvents()}
              >
                Clear Logs
              </Button>
                ...
                {analysis.potentialReloads && (
                  <div className='mt-4 p-3 bg-red-100 border border-red-300 rounded-md'>
                    <div className='font-semibold text-red-800'>
                      ⚠️ Potential Reloads Detected
                    </div>
                    <div className='text-sm text-red-700'>
                      Multiple mount events detected in the last 5 minutes. This
                      may indicate application reloads.
                    </div>
                  </div>
                )}
