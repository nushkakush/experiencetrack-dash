...
export default function BulkFeeManagementDialog({ 
  ...
  const fetchAvailablePaymentPlans = async () => {
    try {
      ...
      const paymentPlans = ['one_shot', 'sem_wise', 'instalment_wise', 'not_selected'];
  ...
  const downloadScholarshipTemplate = async () => {
    try {
      ...
      const headers = 'student_email,scholarship_name,additional_discount_percentage';
          ...
          {disabled ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                This cohort doesn't have any students yet. Add students to the cohort first, then you can manage their scholarships and payment plans.
              </p>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    ...
                    The file should contain student emails and scholarship names.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" className="gap-2" onClick={() => downloadScholarshipTemplate()}>
                  ...
                  <div className="mt-6 p-4 bg-muted rounded-lg">
                    <h4 className="font-medium mb-2">Scholarship Upload Instructions:</h4>
                    ...
                    {availableScholarships.length > 0 && (
                      <div className="mt-4">
                        <h5 className="font-medium mb-2">Available Scholarships:</h5>
                        <div className="flex flex-wrap gap-2">
                          {availableScholarships.map((scholarship, index) => (
                            <Button
                              ...
                              className="text-xs"
                              onClick={() => {
                                navigator.clipboard.writeText(scholarship);
            ...
            <TabsContent value="payment-plans" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Assign payment plans to multiple students using a CSV file.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" className="gap-2" onClick={() => downloadPaymentPlanTemplate()}>
                      <Download className="w-4 h-4" />
                      Download Template
                    </Button>
                  </div>
                  ...
                  {/* Instructions */}
                  <div className="mt-6 p-4 bg-muted rounded-lg">
                    <h4 className="font-medium mb-2">Payment Plan Upload Instructions:</h4>
                    <ul className="text-sm space-y-1">
                      <li><strong>Required columns:</strong> student_email, payment_plan</li>
                    </ul>
                    
                    {availablePaymentPlans.length > 0 && (
                      <div className="mt-4">
                        <h5 className="font-medium mb-2">Available Payment Plans:</h5>
                        <div className="flex flex-wrap gap-2">
