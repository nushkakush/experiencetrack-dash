            ...
            return (
              <TableRow key={stat.student.id} className={stat.rank <= 3 ? 'bg-gray-50' : ''}>
                ...
                <TableCell className="text-center">
                  <span className={StatisticsCalculator.getAttendanceColor(stat.attendancePercentage)}>
                ...
                <TableCell className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">
                    P:{sessionBreakdown.present} L:{sessionBreakdown.late} A:{sessionBreakdown.absent}
                  </div>
                </TableCell>
                <TableCell className="text-center">
