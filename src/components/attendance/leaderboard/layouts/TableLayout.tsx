        ...
        {exemptedRecords.length > 0 && (
          <div className="mt-2 pt-2 border-t border-amber-300">
            ...
            {exemptedRecords.length > 3 && (
              <p className="text-xs text-amber-200">... and {exemptedRecords.length - 3} more</p>
            )}
          </div>
        )}
      </div>
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            {!hideFields.includes('late') && <TableHead className="text-center">Late</TableHead>}
            {!hideFields.includes('absent') && <TableHead className="text-center">Absent</TableHead>}
            ...
            return (
              <TableRow key={stat.student.id}>
                ...
                {!hideFields.includes('email') && (
                  <TableCell className="text-muted-foreground">{stat.student.email}</TableCell>
                )}
                ...
                {!hideFields.includes('late') && (
                  <TableCell className="text-center">{breakdown.late}</TableCell>
                )}
