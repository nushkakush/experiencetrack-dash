...
import { useMagicBriefGeneration } from '@/hooks/useMagicBriefs';
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Generate brand case study challenges based on the active epic's learning outcomes.
          </DialogDescription>
        </DialogHeader>

        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="challenge-count">
