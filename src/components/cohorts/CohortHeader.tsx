              ...
              {canManageFees && (
                ...
                >
                  <Button 
                    ...
                    disabled={!hasStudents}
                    title={!hasStudents ? "Add students to the cohort first" : "Manage scholarships and payment plans for students"}
                  >
                    <Settings className="h-4 w-4" />
                    Bulk Fee Management
                    {!hasStudents && (
                      <span className="ml-1 text-xs text-muted-foreground">(No students)</span>
                    )}
                  </Button>
                </BulkFeeManagementDialog>
              )}
