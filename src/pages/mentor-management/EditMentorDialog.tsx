...
import type { Mentor, UpdateMentorData } from '@/types/mentor';
...
export const EditMentorDialog: React.FC<EditMentorDialogProps> = ({
  mentor,
  open,
  onOpenChange,
  onUpdated,
  ...
  const [form, setForm] = useState<UpdateMentorData>({
    email: '',
    first_name: '',
    last_name: '',
    phone: '',
  ...
  // Initialize form when mentor changes
  useEffect(() => {
    if (mentor) {
      setForm({
        email: mentor.email,
        ...
        experience_years: mentor.experience_years || undefined,
        current_company: mentor.current_company || '',
        designation: mentor.designation || '',
        linkedin_url: mentor.linkedin_url || '',
        bio: mentor.bio || '',
        avatar_url: mentor.avatar_url || '',
        internal_notes: mentor.internal_notes || '',
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    const result = await MentorsService.updateMentor(mentor.id, form);
    setLoading(false);
