...
import { Calendar as CalendarIcon, ChevronLeft, ChevronRight, BarChart3, Settings } from 'lucide-react';
...
export const SessionManagementHeader: React.FC<SessionManagementHeaderProps> = ({
  currentView,
  selectedDate,
  isSessionCancelled,
  isFutureDate,
    ...
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-muted-foreground">
          {currentEpicName} - {currentView === 'manage' ? format(selectedDate, 'MMM d, yyyy') : 'Epic Performance'}
        </p>
      </div>
      <div className="flex items-center gap-4">
        ...
        {currentView === 'manage' && (
          <Button
            ...
            onClick={isSessionCancelled ? onReactivateSession : onCancelSession}
          >
