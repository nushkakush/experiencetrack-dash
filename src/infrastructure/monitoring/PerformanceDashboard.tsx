...
export const PerformanceDashboard: React.FC = React.memo(() => {
  ...
  const getComponentMetrics = async (): Promise<ComponentPerformance[]> => {
    ...
    return Object.entries(bundleMetrics.loadTimes || {}).map(([name, loadTime]) => ({
      name,
      loadTime,
  ...
  const getStatusBadge = (value: number, thresholds: { good: number; needs_improvement: number }) => {
    if (value <= thresholds.good) return <Badge className="bg-green-100 text-green-800">Good</Badge>;
    if (value <= thresholds.needs_improvement) return <Badge className="bg-yellow-100 text-yellow-800">Needs Improvement</Badge>;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              {getStatusBadge(metrics.lcp, { good: 2500, needs_improvement: 4000 })}
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              {getStatusBadge(metrics.fid, { good: 100, needs_improvement: 300 })}
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex items-center justify-between mt-2">
              {getStatusBadge(metrics.cls, { good: 0.1, needs_improvement: 0.25 })}
                  ...
                  <div key={index} className="flex items-center justify-between p-3 border rounded-lg">
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Load: {component.loadTime.toFixed(0)}ms • 
                        Render: {component.renderTime.toFixed(0)}ms • 
