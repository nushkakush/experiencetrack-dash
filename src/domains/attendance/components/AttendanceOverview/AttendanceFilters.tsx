...
export const AttendanceFilters: React.FC<AttendanceFiltersProps> = React.memo(
  ({ filters, onFiltersChange, studentId }) => {
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            ...
            <div className='space-y-2'>
              ...
              <Select
                ...
                onValueChange={value =>
                  onFiltersChange({ ...filters, epicId: value })
                }
              >
                <SelectTrigger>
              ...
              <div className='flex items-center justify-between'>
                <div className='flex flex-wrap gap-2'>
                  ...
                  {filters.epicId !== 'all' && (
                    ...
                    >
                      Epic:{' '}
                      {epics.find(e => e.id === filters.epicId)?.name ||
                        filters.epicId}
                      <button
                        onClick={() =>
                          onFiltersChange({ ...filters, epicId: 'all' })
                        }
                  ...
                  {filters.sessionType !== 'all' && (
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          onFiltersChange({ ...filters, sessionType: 'all' })
                        }
                        className='ml-1 hover:bg-secondary-foreground/20 rounded-full p-0.5'
                      >
                        <X className='h-3 w-3' />
