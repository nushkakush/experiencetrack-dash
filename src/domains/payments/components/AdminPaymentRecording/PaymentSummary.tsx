...
export const PaymentSummary: React.FC<PaymentSummaryProps> = React.memo(
  ({
    ...
    const paymentMethod = PAYMENT_METHODS.find(
      method => method.id === paymentData.paymentMethod
    );
        ...
        <Card className='border-orange-200 bg-orange-50'>
          <CardContent className='p-4'>
            <div className='text-sm text-orange-800'>
              <strong>Important:</strong> Once confirmed, this payment will be
              recorded in the system and cannot be easily undone. Please ensure
