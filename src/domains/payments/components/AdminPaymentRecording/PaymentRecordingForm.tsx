...
export const PaymentRecordingForm: React.FC<PaymentRecordingFormProps> = React.memo(({
  studentId,
  studentName,
  outstandingAmount,
  onSubmit,
  ...
  const validateForm = useCallback((): boolean => {
    ...
    if (['bank_transfer', 'upi', 'card', 'razorpay'].includes(formData.paymentMethod) && !formData.transactionId) {
  ...
  const updateFormData = useCallback((updates: Partial<PaymentRecordingData>) => {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {formData.amount > 0 && formData.amount <= outstandingAmount && (
              <div className="text-sm text-green-600">
                Remaining after payment: {formatCurrency(outstandingAmount - formData.amount)}
              </div>
            )}
          </div>
          ...
          {['bank_transfer', 'upi', 'card', 'razorpay'].includes(formData.paymentMethod) && (
            <div className="space-y-2">
