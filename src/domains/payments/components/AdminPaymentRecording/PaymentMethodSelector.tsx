...
export const PaymentMethodSelector: React.FC<PaymentMethodSelectorProps> = React.memo(({
  value,
  onChange,
  disabled = false,
  error,
  ...
  const digitalMethods = PAYMENT_METHODS.filter(method => method.category === 'digital');
  const traditionalMethods = PAYMENT_METHODS.filter(method => method.category === 'traditional');
        ...
        <Card className="bg-primary/5 border-primary/20">
          <CardContent className="p-3">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="font-medium">Selected: {selectedMethod.label}</span>
            </div>
