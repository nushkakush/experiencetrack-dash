...
import { MoreHorizontal, DollarSign, Eye, Edit, Receipt } from 'lucide-react';
...
export const PaymentScheduleItem: React.FC<PaymentScheduleItemProps> = React.memo(({
  item,
  onRecordPayment,
  onViewDetails,
  onEditPayment,
  ...
  const getItemDescription = () => {
    const baseType = typeConfig[item.type as keyof typeof typeConfig] || item.type;
